...
@section('content')
                ...
                <div class="card border-0 shadow-lg header-card"
                    ...
                    <div class="card-body py-4">
                        <h1 class="display-5 fw-bold text-primary mb-0">
                            <i class="bi bi-check-square me-3"></i>Görevi Tamamla
                        </h1>
                        <p class="lead text-muted mt-2">Görevinizi tamamlayın</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-8 col-xl-6">
                <div class="card border-0 shadow-lg form-card"
                    ...
                    <div class="card-body p-5">
                        ...
                        {{-- Form --}}
                        <form action="{{ route('complete_task', $task->id) }}" method="POST" class="needs-validation"
                            novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4 form-floating-custom">
                                <label for="completed_title" class="form-label fw-semibold">
                                    <i class="bi bi-card-text text-primary me-2"></i>İşlem Başlığı
                                </label>
                                <input type="text" name="completed_title"
                                    class="form-control form-control-lg custom-input" value=""
                                    placeholder="Örn: Kod hataları düzeltildi..." required>
                                <div class="invalid-feedback">
                                    Lütfen işlem başlığı giriniz.
                                </div>
                            </div>

                            {{-- Task Content --}}
                            <div class="mb-4 form-floating-custom">
                                <label for="completed_content" class="form-label fw-semibold">
                                    <i class="bi bi-textarea-t text-success me-2"></i>İşlem Açıklaması
                                </label>
                                <textarea required name="completed_content" rows="4" class="form-control form-control-lg custom-textarea"
                                    placeholder="Yapılan işlem hakkında detaylı bilgi veriniz..."></textarea>
                                <small class="form-text text-muted ">Bu alan zorunludur!</small>
                            </div>

                            {{-- Task Date --}}
                            <div class="mb-5 form-floating-custom">
                                <label for="completed_date" class="form-label fw-semibold">
                                    <i class="bi bi-calendar-event text-warning me-2"></i>İşlem Tamamlanma Tarihi
                                </label>
                                <input type="date" name="completed_date"
                                    class="form-control form-control-lg custom-input" value="#" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="d-grid gap-3 d-md-flex justify-content-md-end">
                                ...
                                <form method="POST" action="{{ route('complete_task', $task->id) }}" class="flex-fill">
                                    @csrf
                                    @method('POST')
                                    <button class="btn btn-success btn-lg px-4 submit-btn" type="submit">
                                        <i class="bi bi-check-square me-1"></i> Görevi Tamamla
                                    </button>
                                </form>
                                {{-- <button type="submit" class="btn btn-success btn-lg px-4 submit-btn">
                                <i class="bi bi-save me-2"></i>Görevi Tamamla
                            </button> --}}
                            </div>
                        </form>
                    </div>
                ...
                <div class="card border-0 shadow-sm tips-card"
                    ...
                    <div class="card-body p-4">
                        <h6 class="fw-bold text-muted mb-3">
                            <i class="bi bi-lightbulb text-warning me-2"></i>Tamamlama İpuçları
                        </h6>
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-check-circle text-success me-2"></i>
                                    <small class="text-muted">Başlığı açık tutun</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-check-circle text-success me-2"></i>
                                    <small class="text-muted">Notu detaylandırın</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-check-circle text-success me-2"></i>
                                    <small class="text-muted">Tarihi kontrol edin</small>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Highlight changes on form load
        document.addEventListener('DOMContentLoaded', function() {
