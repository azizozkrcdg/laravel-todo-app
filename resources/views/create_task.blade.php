                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('taskAdd') }}" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="mb-4 form-floating-custom">
                                ...
                                <input type="text" name="task_title" class="form-control form-control-lg custom-input"
                            ...
                            <div class="mb-4 form-floating-custom">
                                ...
                                <textarea name="task_content" rows="4" class="form-control form-control-lg custom-textarea" required
                                    placeholder="Göreviniz hakkında detaylı bilgi veriniz..."></textarea>
                                <div class="invalid-feedback">
                                    Lütfen görev açıklaması giriniz.
                                </div>
                            </div>
                            ...
                            <div class="mb-5 form-floating-custom">
                                ...
                                <input type="date" name="task_date" class="form-control form-control-lg custom-input"
                                    min="{{ $today }}" required>
                                <div class="invalid-feedback">
