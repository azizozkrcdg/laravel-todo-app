            ...
            <div class="d-flex flex-column flex-sm-row align-items-stretch">
                ...
                <div class="flex-grow-1 p-4" style="border-bottom: 0.5px solid rgba(0,0,0,0.08); border-right: none;">
                    <span class="badge mb-2 px-3 py-1"
                        style="margin-buttom:3px; background:#E6F1FB;color:#0C447C;font-size:10px;font-weight:500;letter-spacing:0.4px;text-transform:uppercase;border-radius:20px;">
                        <i class="bi bi-clipboard-check me-1"></i>Görev Paneli
                    </span>
                    <div class="d-flex align-items-center gap-3 mb-1">
                        <div class="d-flex align-items-center justify-content-center rounded-3 border border-dark flex-shrink-0"
                            style="width:40px;height:40px;background:transparent;">
                            <i class="bi bi-clipboard-check text-dark" style="font-size:1.2rem;"></i>
                        </div>
                ...
                <div class="d-flex align-items-center gap-3 p-3 flex-shrink-0"
                    ...
                    <div class="rounded-circle border border-dark d-flex align-items-center justify-content-center text-dark fw-semibold flex-shrink-0"
                        style="width:44px;height:44px;font-size:0.95rem;background:transparent;">
                        {{ strtoupper(substr(auth()->user()->name, 0, 2)) }}
                    </div>
                    <div class="flex-grow-1 min-width-0">
                        <div class="fw-semibold text-dark text-truncate" style="font-size:0.88rem;">{{ auth()->user()->name }}</div>
                        <div class="text-muted" style="font-size:0.75rem;">Kullanıcı</div>
                    </div>
